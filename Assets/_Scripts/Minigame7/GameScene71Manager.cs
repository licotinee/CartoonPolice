...
public class GameScene71Manager : MonoBehaviour
{
    ...
    [SerializeField] ShadeBg shadeStart;
    [SerializeField] ShadeBg shadeEnd;
    private void Awake()
    {
    ...
    private void Start()
    {
        shadeStart.gameObject.SetActive(true);
        SoundManager.Instance.PlayBGM(SoundTag.Bgm_dog_search);
    }
    ...
    IEnumerator MoveToSuitcase(GameObject suitcase)
    {
        ...
        SoundManager.Instance.PlaySFXOneShot(SoundTag.Eff_dog_sniff);
        //wolfoo.Reset();
        ...
        SoundManager.Instance.PlaySFXOneShot(SoundTag.Eff_dog_singleBark);
    ...
    {
        SoundManager.Instance.PlaySFX(SoundTag.Eff_cheer_smallwin);
        isEndgame = true;
        dog.Reset();
        wolfoo.Reset();
        ...
        yield return new WaitForSeconds(2f);
        shadeEnd.gameObject.SetActive(true);
        LoadNewScene();
    }
