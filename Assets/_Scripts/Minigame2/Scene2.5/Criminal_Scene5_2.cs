...
public class Criminal_Scene5_2 : MonoBehaviour
{
    ...
    IEnumerator StartScaleUp()
    {
        ...
        SoundManager.Instance.PlaySFXOneShot(SoundTag.Eff_witch_footstep);
    ...
    IEnumerator StartAttack()
    {
        curBullet = 0;
        Handheld.Vibrate();
        SoundManager.Instance.PlaySFXOneShot(SoundTag.Eff_witch_attack_01);
    ...
    {
        SoundManager.Instance.PlaySfxLoop(SoundTag.Eff_witch_growl);
...
/*        if (GameScene25Manager.ins.isEndGame)
    ...
    {
        SoundManager.Instance.StopSfxLoop();
        SoundManager.Instance.PlaySFX(SoundTag.Eff_witch_endgame);
