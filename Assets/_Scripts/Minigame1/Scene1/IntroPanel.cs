...
public class IntroPanel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SoundManager.Instance.PlaySfxLoop(SoundTag.Eff_report_ring);
    }
    ...
    void OnClick()
    {
        ...
        SoundManager.Instance.PlaySFX(SoundTag.Eff_report_phone);
    }
    ...
    IEnumerator MoveCenterCamera(GameObject ob)
    {
        ...
        rect.DOAnchorPos(new Vector3(0, -80, 0), 0.1f);
