...
public class RihinoMinigame6 : MonoBehaviour
{
    ...
    private void BeCatched()
    {
        ...
        SoundManager.Instance.PlaySFXOneShot(SoundTag.Eff_rhino_surprise);
        DOVirtual.DelayedCall(1, () =>
        {
            SoundManager.Instance.PlaySFXOneShot(SoundTag.Eff_obi_escape);
    ...
    IEnumerator MoveToStartGame()
    {
        ...
        SoundManager.Instance.PlaySFXOneShot(SoundTag.Eff_rhino_run);
